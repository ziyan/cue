...
- Record the decision, the reasoning, and what it costs. A record with no
  consequences section is usually one that has not been thought through.
- Keep them short. If it needs more than a page, the design belongs in a plan
  under `docs/planning/active/` and the record points at it.
